...
public class PhysicsAlgorithms {
     ...
     * @return estimative fuelConsumption range of aircraftModel in cruise
     * flight
     */
    ...
    public static double calculateFuelConsumption(double time, double TSFC, double thrust) {
        return TSFC * thrust * time;
    }
